...
// ║  CLIENT VIEW                                     ║
// ╚══════════════════════════════════════════════════╝
function ClientView({ products, onOrderSubmitted, printOrder }) {
          ...
          <div className="card" style={{ textAlign: 'center', padding: '48px 24px', marginTop: '24px' }}>
            ...
            <div className="flex flex-col gap-3">
              <a
                ...
                onClick={() => {
                  if (fullOrder) printOrder(fullOrder);
                }}
...
<body>
  ...
  // GLOBAL MONITOR - Prints even if we are anywhere
  useEffect(() => {
  ...
  return (
    <BrowserRouter>
      <div className="app">
        <Routes>
          {/* Rota do Cliente */}
          <Route path="/" element={<ClientView products={products} printOrder={printOrder} />} />
